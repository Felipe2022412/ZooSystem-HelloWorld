...
import zoosystem.helloworld.HabitatType;
...
public class ZooImp implements Zoo {
    ...
    this.animals = new ArrayList<>();
     ...
     // String behaviour, boolean hunger, boolean healthy) - implemented in the cuntructor
     
     //couldnt parse the enums to String in the constructor - could create a method to convert the enum but no timeeee sorryyyyy saaaaaaam
     
    animals.add(new Mammal("Lion", 12, 200, HabitatType.HabitatTypes.JUNGLE.toString(), "roar", true, true)); // true for hunger and healthy
    animals.add(new Bird("Eagle", 5, 9,HabitatType.HabitatTypes.FOREST, "woaaah", true, true)); // true for hunger and healthy
    animals.add(new Fish("Baby Shark", 2,3,HabitatType.HabitatTypes.ARTIC, "tu tu tu tururu", true, true)); // true for hunger and healthy
    ...
    public void listAllAnimals(){
            ...
            for(Animal animal: animals){
                ...
                if(animal instanceof Mammal){
                    ...
                    //String behaviour, boolean hunger, boolean healthy) - extra to be listed
                    ...
                    System.out.println("Hungry: " + mammal.isHunger());
                    System.out.println("Healthy: " + mammal.isHealthy());
                    ...
                    System.out.println("Hungry: " + fish.isHunger());
                    System.out.println("Healthy: " + fish.isHealthy());
                    ...
                    System.out.println("Hungry: " + bird.isHunger());
                    System.out.println("Healthy: " + bird.isHealthy());
            } 
            System.out.println("-----------------------");              
          }
    }
...
//                                            System.out.println("printing split" + mammalDetails);
                                            zoo.addAnimal(new Mammal(
                                                    ...
                                                    mammalDetails[4].trim(), // behaviour
                                                    Boolean.parseBoolean(mammalDetails[5].trim()),//hunger
                                                    Boolean.parseBoolean(mammalDetails[6].trim()) //healthy
...
//                                      ValueError
                            ...
                            System.out.println("Name, Age, Weight, Habitat, Behaviour, Hunger (T/F), Healthy(T/F)");
                        } 
                    break;
                    case 2:
                        System.out.println("Please provide the Fish (\"Name, Age, Weight, Habitat, Behaviour, Hunger (T/F), Healthy(T/F)\")");
//                        Take the user input and store it in a string array []
//                        The data structure is a CSV comma seperated 
//                        userinput = "Lion, 12, 120, Jungle"
//                        Specify the delim using split() == ,
...
//                                            System.out.println("printing split" + mammalDetails);
                                            zoo.addAnimal(new Fish(
                                                    ...
                                                    fishDetails[4].trim(), // behaviour
                                                    Boolean.parseBoolean(fishDetails[5].trim()),//hunger
                                                    Boolean.parseBoolean(fishDetails[6].trim()) //healthy
...
//                                            System.out.println("printing split" + mammalDetails);
                                            zoo.addAnimal(new Bird(
                                                    ...
                                                    birdDetails[4].trim(), // behaviour
                                                    Boolean.parseBoolean(birdDetails[5].trim()),//hunger
                                                    Boolean.parseBoolean(birdDetails[6].trim()) //healthy
                                            ));
                                }else{
//                                    If the input is mismatching the type of value 
//                                      ValueError
